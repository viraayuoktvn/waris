...
def dt_c45(Xdata, ydata, pre_pruning = "none", chi_lim = 0.1, min_lim = 10):
...
X = df[['total_ap', 'total_al', 'total_cl', 'total_cp', 'total_suami', 'total_istri', 'total_ayah', 'total_ibu', 'total_kakek', 
        'total_nenek', 'total_si', 'total_sdlk', 'total_sdpk']]  # Fitur, tetap sebagai integer
y = df[['hw_sdpk']]  # Target, tetap sebagai string

start_time = time.time()
dt_model = dt_c45(Xdata=X, ydata=y, pre_pruning="impur")
end_time = time.time()
