...
def calculate_inheritance(total_assets, total_debts, will, medical_expenses, funeral_expenses, family_members):
...
def main():
    ...
    # Mengukur waktu eksekusi perhitungan total warisan
    start_time = time.time()
    total_inheritance = calculate_inheritance(total_assets, total_debts, will, medical_expenses, funeral_expenses, family_members)
    end_time = time.time()
    print(f"Waktu eksekusi perhitungan total warisan: {end_time - start_time} detik")
    ...
    if family_members.get("total_istri", 0) > 0:
    ...
    if family_members.get("total_ayah", 0) > 0:
    ...
    if family_members.get("total_ibu", 0) > 0:
    ...
    if family_members.get("total_kakek", 0) > 0:
    ...
    if family_members.get("total_nenek", 0) > 0:
    ...
    if family_members.get("total_al", 0) > 0:  # Anak laki-laki
    ...
    if family_members.get("total_ap", 0) > 0:  # Anak perempuan
    ...
    if family_members.get("total_cl", 0) > 0:  # Cucu laki-laki dari anak laki-laki
    ...
    if family_members.get("total_cp", 0) > 0:  # Cucu perempuan dari anak laki-laki
    ...
    if family_members.get("total_si", 0) > 0:  # Saudara seibu
    ...
    if family_members.get("total_sdlk", 0) > 0:  # Saudara kandung laki-laki
    ...
    if family_members.get("total_sdpk", 0) > 0:  # Saudara kandung perempuan
